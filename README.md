...
c
Realizado o commit e o push com sucesso, repare que na hora que realizei o "push" ele pediu o usuário e senha do GitHub é possível configurar para não solicitar senha, mas por hora vamos tocar desta forma.
